...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if ((Input.GetKey(leftMouse) && Input.GetKey(rightMouse)) || Input.GetKey(middleMouse)) // if left and right mouse button or middle mouse is pressed
    ...
    void CameraCollisions()
    {
        ...
        {
            Vector3 clipPoint = mainCam.transform.up * camClip[i].y + mainCam.transform.right * camClip[i].x + mainCam.transform.forward * camClip[i].z;
